var LR_websiteid = 'PUT70409253';
var LR_ssl = 0;
var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_js_pm = 'd';
var LR_sysurl = 'http://put.zoosnet.net/';
var LR_lng = 'cn';
var LR_dcbfb='7BA6F339084246758CD8E818095830C0';var LR_siteid = '70409253';
LR_dcbfb=LR_dcbfb.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');if(typeof(LR_showfloat)=='undefined')var LR_showfloat = 0;
var LR_imgurl = 'http://put.zoosnet.net/';
LR_dcbfb=LR_dcbfb.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LiveReceptionCode_isonline = 0;
var LR_isMobile = 0;
var LR_27a2a=LR_dcbfb.replace(/1/g,'3').replace(/0/g,'2');var LR_FDAL=LR_27a2a.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&IJOE='+LR_FDAL;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://put.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
