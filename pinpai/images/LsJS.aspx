...
var LR_js_pm = 'd';
var LR_siteid = '70409253';
if(typeof(LR_showfloat)=='undefined')var LR_showfloat = 0;
var LR_lng = 'cn';
var LR_4d08f='01FDA3A50A9C49F49012C11F5D85AB95';var LR_websiteid = 'PUT70409253';
LR_4d08f=((3+1).toString()+LR_4d08f+(3*1).toString());var LR_ssl = 0;
var LR_9ae9f=LR_4d08f.replace(/1/g,'3').replace(/0/g,'2');LR_9ae9f=LR_9ae9f.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_JBDB=LR_9ae9f.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&KKAE='+LR_JBDB;
